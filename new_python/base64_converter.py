...
def base64_converter(input):
    ...
    for x in range(len(input)):
        current_set = base64_strings[input[x]]
        string_one += current_set[0:2]
        string_two += current_set[2:4]
        string_three += current_set[4:6]
        pass
    ...
    for x in range(int(len(matrix_string) / 6)):
        ...
        input += base64_reversion[current_set]
        pass
